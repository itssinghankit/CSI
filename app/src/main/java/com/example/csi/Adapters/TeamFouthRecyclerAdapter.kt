...
class TeamFouthRecyclerAdapter(val arrayList: List<TeamDataClassItem>,val context:Context) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(context).load(arrayList[position].video).placeholder(R.drawable.fakeimage).into(holder.personImage)
    }
